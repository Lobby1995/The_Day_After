...
- A world view: press World in the header and the game is drawn as a small isometric place (29 of them: rooms for every profession, a ward, a chapel, a harbor, a rooftop, a cellar, a checkpoint and more, chosen by what the question is about). You walk (arrow keys, WASD, or a tap) to the glowing ring, and the question opens there. One to three zombies walk toward you, and a bite costs 3 to 5 health and 5 infection. Same game underneath: same questions, same rolls
