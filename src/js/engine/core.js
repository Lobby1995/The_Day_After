...
function defEv(o){
  ...
  add({id:o.id,title:o.t[0],text:o.x[0],cond:o.cond,w:o.w||16,max:o.max,once:o.once===undefined?true:o.once,wild:o.wild,story:o.story,open:o.open,pro:o.pro,dil:o.dil,pre:o.pre,pair:o.pair||[0,1],choices});
